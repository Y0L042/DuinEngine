...
TEST_SUITE("AssetIndex")
{
    ...
    TEST_CASE("UpdateAsset - updates an existing asset")
    {
        ...
        updated.hintPath = "assets/texture_v2.png";
    ...
    TEST_CASE("EnsureAsset - overwrites existing asset")
    {
        ...
        duin::AssetRef updated;
        updated.uuid = ref.uuid;
        updated.hintPath = "assets/model_v2.blend";
    ...
    TEST_CASE("Serialize and Deserialize - many assets round-trip")
    {
        ...
        for (int i = 0; i < 150; i++)
        {
            duin::AssetRef ref;
            ref.uuid = duin::UUID();
            ref.hintPath = "assets/item_" + std::to_string(i);
    ...
    TEST_CASE("Multiple operations sequence")
    {
        ...
        ref1Updated.hintPath = "assets/a_updated.png";
    ...
    TEST_CASE("Stress - 5000 assets add, lookup, and remove")
    {
        ...
        for (int i = 0; i < COUNT; i++)
        {
            duin::AssetRef ref;
            ref.uuid = duin::UUID();
            ref.hintPath = "assets/stress/item_" + std::to_string(i) + ".png";
    ...
    TEST_CASE("Stress - 10000 assets serialize and deserialize round-trip")
    {
        ...
        for (int i = 0; i < COUNT; i++)
        {
            duin::AssetRef ref;
            ref.uuid = duin::UUID();
            ref.hintPath = "assets/project/folder_" + std::to_string(i / 100) + "/asset_" + std::to_string(i);
