...
#pragma warning(                                                                                                       \
    disable                                                                                                            \
    : 26812) // The enum type 'xxx' is unscoped. Prefer 'enum class' over 'enum' (Enum.3). [MSVC Static Analyzer)
#pragma warning(                                                                                                       \
    disable                                                                                                            \
...
// Utilities
// (other types which are not forwarded declared are: ImBitArray<>, ImSpan<>, ImSpanAllocator<>, ImPool<>,
// ImChunkStream<>)
...
struct IMGUI_API ImGuiWindow
{
  ...
  public:
    ...
    {
        ImGuiContext &g = *Ctx;
        return g.FontBaseSize * FontWindowScale * FontDpiScale * FontWindowScaleParents;
    }
...
IMGUI_API bool ImageButtonEx(ImGuiID id, ImTextureID user_texture_id, const ImVec2 &image_size, const ImVec2 &uv0,
...
IMGUI_API void ImFontAtlasBuildSetupFont(ImFontAtlas *atlas, ImFont *font, ImFontConfig *src, float ascent,
                                         float descent);
...
IMGUI_API void ImFontAtlasBuildGetOversampleFactors(const ImFontConfig *src, int *out_oversample_h,
