...
typedef struct Matrix
{
    ...
    Matrix()
        : m0(0.0f), m4(0.0f), m8(0.0f), m12(0.0f), m1(0.0f), m5(0.0f), m9(0.0f), m13(0.0f), m2(0.0f), m6(0.0f),
          m10(0.0f), m14(0.0f), m3(0.0f), m7(0.0f), m11(0.0f), m15(0.0f)
    {
    }
    ...
    Matrix(const Vector4 &row1, const Vector4 &row2, const Vector4 &row3, const Vector4 &row4)
        : m0(row1.x), m4(row1.y), m8(row1.z), m12(row1.w), m1(row2.x), m5(row2.y), m9(row2.z), m13(row2.w), m2(row3.x),
...
#define EPSILON 0.000001f
    ...
    __m128 refined =
        _mm_mul_ss(rsqrt, _mm_sub_ss(three, _mm_mul_ss(half, _mm_mul_ss(input, _mm_mul_ss(rsqrt, rsqrt)))));
...
#endif
    float result = 0.0f;
    int zero = ((fabsf(v.x)) <= (EPSILON)) && ((fabsf(v.y)) <= (EPSILON)) && ((fabsf(v.z)) <= (EPSILON));
...
#define EPSILON 0.000001f
    ...
    Quaternion q = {axis.x * sinHalfAngle, axis.y * sinHalfAngle, axis.z * sinHalfAngle, cosHalfAngle};
