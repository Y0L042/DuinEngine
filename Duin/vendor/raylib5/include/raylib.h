...
//---------------------------------------------------------------------------------- 
// Prevents conflicts with some Windows.h / WinUser.h functions
//----------------------------------------------------------------------------------
#if defined(_WIN32)           
    #define NOGDI             // All GDI defines and routines
    #define NOUSER  
    #define PlaySound PlaySound_Ignore   // Prevent conflict with Windows API PlaySound// All USER defines and routines
#endif
...
#include <Windows.h> // or any library that uses Windows.h
    ...
    #undef near
    #undef far
    #undef PlaySound           // Restore PlaySound macro to original state after including Windows.h
#endif
//----------------------------------------------------------------------------------
